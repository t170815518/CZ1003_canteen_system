store_menu = { "Yong Tau Foo" : {"morning" : ["Bee Hoon", "Kuay Teow"],
    ...
    "Chicken Rice" : {"morning" : ["Steamed Chicken Rice"],
                      "afternoon" : ["Roasted Chicken Rice"],
                      "monday" : [] ,
                      "wednesday" : ["Specialty Chicken Rice Set"],
                      "sep" : [] },

    "Hand-made Noodles" : {"morning" : ["Sliced Fish Soup", "Ban Mian"] ,
                           "afternoon" : ["Tom Yam Seafood Noodles"],
                           "monday" : [] ,
                           "wednesday" : [],
                           "sep" : []},

    "Cantonese Roast Duck" : {"morning" : ["Specialty Duck Rice", "Duck Noodles"],
                              "afternoon" : ["Roasted Pork Rice"],
                              "monday" : [] ,
                              "wednesday" : [],
                              "sep" : []},

    "Western Food" : {"morning" : ["Chicken Chop", "Fish and Chips"],
                      "afternoon" : ["Seafood Spaghetti"],
                      "monday" : [] ,
                      "wednesday" : [],
                      "sep" : []},

    "Salad" : {"morning": ["Chicken Salad", "Garden Salad"],
               "afternoon" : ["Salmon Salad"],
               "monday" : [] ,
               "wednesday" : [],
               "sep" : []},

    "Starbuck's Coffee" : {"morning" : ["Americano", "Latte", "Cappucino"] ,
                           "afternoon" :  [],
                           "monday" : [] ,
                           "wednesday" : [],
                           "sep" : []},

    "McDonald's" : {"morning" : ["McMuffin", "Big Breakfast", "Hotcakes"],
                    "afternoon" : ["McChicken", "McSpicy", "Fillet O' Fish"],
                    "monday" : [] ,
                    "wednesday" : [],
                    "sep" : [] }}
...
def get_menu(store_name, TIME, mode):
    if mode == 1:     #When mode ==1, displays all items regardless of time. mode == 0 is default value.
...
if __name__ == '__main__':
    ...
    print(get_menu(store_name, TIME,mode))
